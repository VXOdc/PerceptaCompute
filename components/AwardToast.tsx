...
const TIER_COLORS: Record<Award['tier'], { border: string; bg: string; text: string; label: string }> = {
  ...
  silver:   { border: 'rgba(192,192,192,0.5)', bg: 'rgba(100,116,139,0.08)', text: '#64748b', label: 'Silver'   },
  gold:     { border: 'rgba(37,99,235,0.4)',  bg: 'var(--accent-soft)',  text: 'var(--accent)', label: 'Gold'     },
  platinum: { border: 'rgba(37,99,235,0.5)',  bg: 'var(--accent-soft)', text: 'var(--accent)', label: 'Platinum' },
};
